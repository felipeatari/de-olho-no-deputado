                    ...
                    <tbody>
                        @forelse($despesas as $despesa)
                            <tr class="bg-white hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <img src="{{ $despesa['url_foto'] }}" alt="{{ $despesa['nome'] }}"
                                        class="w-12 h-12 rounded-full object-cover mx-auto">
                                </td>
                                <td class="px-4 py-3 text-center align-middle text-gray-900">{{ $despesa['nome'] }}</td>
                                <td class="px-4 py-3 text-center align-middle">{{ $despesa['sigla_partido'] }}</td>
                                <td class="px-4 py-3 text-center align-middle">{{ $despesa['sigla_uf'] }}</td>
